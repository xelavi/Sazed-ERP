          ...
          <div class="drawer-body">
            ...
            <div v-if="invoice.hashActual" class="detail-section verifactu-section">
              ...
              <div class="detail-row">
                ...
                <span :class="['badge', vfBadgeClass(invoice.estadoAeat)]">{{ invoice.estadoAeat }}</span>
              </div>
